...
public class EventListFragment extends ListFragment {
     ...
     * selections.
     */
    private ArrayList<EventDataStorage> events = new ArrayList<EventDataStorage>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey("events")){
            ...
            Log.v("myApp", "List Fragment: argument first event:" + events.get(1).EventName);
        }
        setListAdapter(new ArrayAdapter<EventDataStorage>(
                getActivity(),
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
       ...
       // mCallbacks.onItemSelected(DummyContent.ITEMS.get(position).id);
        mCallbacks.onItemSelected((EventDataStorage) listView.getItemAtPosition(position));
    }
